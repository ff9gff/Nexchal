...
<h2>게시글 목록</h2>
	...
	<table border="1" width="600px">
	    ...
	    <tr>
            ...
            <td><a href="${path}/board/boardInfo.do?bno=${row.bno}&curPage=${map.boardPager.curPage}&searchOption=${map.searchOption}&keyword=${map.keyword}">${row.title}</a></td>
	        <%-- <td><a href="${path}/board/boardInfo.do?bno=${row.bno}">${row.title}</a></td> --%>
	        <td>${row.username}</td>
	        <td>
