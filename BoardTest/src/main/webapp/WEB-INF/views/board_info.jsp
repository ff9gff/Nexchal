...
<form name="form1" method="post">
    ...
    <div>
        내용
        <textarea name="content" id="content" rows="4" cols="80" placeholder="내용을 입력해주세요">${boardvo.content}</textarea>
    </div>
    <div>
        이름
        <input name="writer" id="writer" value="${boardvo.writer}" placeholder="이름을 입력해주세요">
    </div>
